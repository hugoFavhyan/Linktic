<?php
namespace CCFEF\feedback;

if ( ! defined( 'ABSPATH' ) ) {
	exit; }

class ccfef_feedback {

		private $plugin_url     = CCFEF_PLUGIN_URL;
		private $plugin_version = CCFEF_VERSION;
		private $plugin_name    = 'Country Code For Elementor Form Telephone Field';
		private $plugin_slug    = 'country-code-field-for-elementor-form';
