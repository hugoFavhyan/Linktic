...
* Fixed: Template Library Import JSON Issue.
* Update: Video Tutorial and Documentation Link.

= Version: 1.2.2 - Date: 2023-04-06 =
* Added: Nonce verification for recommended plugins.
* Added: Nonce verification for template library import.

= Version: 1.2.1 - Date: 2022-11-07 =
* Compatibility with the latest WordPress version.

= Version: 1.2.0 - Date: 2022-09-13 =
* Added: Recommendations submenu

= Version: 1.1.9 - Date: 2021-06-05 =
* Improved: Megamenu settings options into popup field
* Improved: Megamenu settings options saved by ajax
* Compatible with Elementor latest version

= Version: 1.1.8 - Date: 2021-09-01 =
* Compatible with Elementor latest version

= Version: 1.1.7 - Date: 2021-07-25 =
* Compatible with WordPress latest version

= Version: 1.1.6 - Date: 2021-04-26 =
* Compatible with Elementor latest version

= Version: 1.1.5 - Date: 2021-04-11 =
* Active menu color option added

= Version: 1.1.4 - Date: 2021-01-06 =
* Capability With latest WordPress Version

= Version: 1.1.1 - Date: 2019-12-31 =
* Setting Page Redirect Issue Solved

= Version: 1.1.0 - Date: 2019-12-08 =
...
2. Search For "HT Mega Menu".
3. Install, then Activate it.

= OR: =
1. Unzip (if it is zipped) and Upload `ht-menu-lite` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress

== Screenshots ==
1. Menu Options
2. Menu Template Settings Options
3. Menu Options Panel
4. Front end View
